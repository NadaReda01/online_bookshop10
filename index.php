            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="frontassets/demos/about.html">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="frontassets/demos/categories.html">Categories</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="frontassets/demos/Gallery.html">Gallery</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="img" class="col-lg-6 col-md-5">
                    <img id="img1" src="frontassets/image/2.jpg" />
                    <img id="img2" src="frontassets/image/25.jpg" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container text-center" id="section2">
        ...
        <div class="row">
            ...
            <div class="box col-lg-3 col-md-6 col-11">
                <a href="demos/books.html">
                    <img src="frontassets/image/27.jpg" />
                    <h4 class="font-weight-bolder">Religious books</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione
                        eius recusandae, porro ipsa necessitatibus autem!
                    </p>
                </a>
            </div>
            ...
            <div class="box col-lg-3 col-md-6 col-11">
                <a href="#">
                    <img src="frontassets/image/40.jpg" />
                    <h4 class="font-weight-bolder">Sciences books</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione
                        eius recusandae, porro ipsa necessitatibus autem!
                    </p>
            ...
            <div class="box col-lg-3 col-md-6 col-11">
                <a href="#">
                    <img src="frontassets/image/26.jpg" />
                    <h4 class="font-weight-bolder">Romantic books</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione
                        eius recusandae, porro ipsa necessitatibus autem!
                    </p>
            ...
            <div class="box col-lg-3 col-md-6 col-11">
                <a href="#">
                    ...
                    <h4 class="font-weight-bolder">Programing books</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione
                        eius recusandae, porro ipsa necessitatibus autem!
                    </p>
    ...
    <section id="section5">
        ...
        <div>
            <div class="regular slider">
                <div><img src="frontassets/image/54.jpg" /></div>
                <div><img src="frontassets/image/50.jpg" /></div>
                <div><img src="frontassets/image/51.jpg" /></div>
                <div><img src="frontassets/image/52.jpg" /></div>
                <div><img src="frontassets/image/53.jpg" /></div>
                <div><img src="frontassets/image/50.jpg" /></div>
            </div>
        </div>
        ...
        <div class="container text-center">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="demos/about.html">About</a></li>
                    <li><a href="demos/categories.html">categories</a></li>
                    <li><a href="demos/contact.html">Contact</a></li>
                </ul>
            </nav>
            <ul id="ulicon2">
                <li>
